...
cc = f"ccache {"gcc" if plat == 1 else "i686-elf-gcc"} \"-I{project_root}/include\" -static -fno-toplevel-reorder -mgeneral-regs-only -fno-stack-protector -fno-pic -fno-pie -no-pie -ffreestanding -m32 -mhard-float -mfpmath=387 -c {"-w" if fast else ""}" # -Wall -Wextra -c"
