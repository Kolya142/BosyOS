...
gcc mezdoc.c -o ../build/mzd.o -fno-plt -fno-pic -fno-pie -static -fno-toplevel-reorder -mgeneral-regs-only -ffreestanding -m32 -mhard-float -nostartfiles -mfpmath=387 -c
