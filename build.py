...
cc = f"ccache gcc \"-I{project_root}/include\" -static -fno-toplevel-reorder -mgeneral-regs-only -fno-stack-protector -fno-pic -fno-pie -no-pie -ffreestanding -m32 -mhard-float -mfpmath=387 -c {"-w" if fast else ""}" # -Wall -Wextra -c"
...
print("Linking")
run_command(f"ld -m elf_i386 -T link.elf.ld build/KMain.o {obj_files} -o kernel.elf") # --verbose")
